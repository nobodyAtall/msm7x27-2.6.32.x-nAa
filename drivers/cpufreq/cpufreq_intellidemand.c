...
if (policy->cur < policy->max) {
if (policy->cur < 800000) dbs_freq_increase(policy, 1000000);
else if (policy->cur < 1000000) dbs_freq_increase(policy, 1200000);
else {
this_dbs_info->rate_mult = dbs_tuners_ins.sampling_down_factor;
dbs_freq_increase(policy, policy->max);
}
...
#define ACTIVE_MAX_FREQ 1401600 // 1.56GHz
#else
#define ACTIVE_MAX_FREQ 1612000 // 1.78GHz
#endif
#define INACTIVE_MAX_FREQ 1017600 // 1.0GHZ
